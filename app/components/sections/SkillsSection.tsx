        ...
        <section id="skills" className="min-h-screen flex items-center py-20 px-6">
            <div className="max-w-7xl mx-auto w-full">
                <div className="text-center mb-16">
                    <h2 className="text-sm font-bold tracking-widest text-indigo-500 uppercase mb-3">My Arsenal</h2>
                ...
                <div className="mb-16">
                    <h4 className="text-lg font-semibold text-white mb-8 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-6 gap-6 max-w-4xl mx-auto">
                        {languagesAndFrameworks.map((skill) => (
                            <div key={skill.name} className="flex flex-col items-center group">
                                ...
                                <span className="text-gray-400 text-xs mt-3 group-hover:text-white transition-colors">
                                    {skill.name}
                                </span>
                            </div>
                        ))}
